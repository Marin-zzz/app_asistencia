            ...
            this.toCanvas(canvasElement, config).then(() => {
              ...
              if (centerImageSrc && this.context) {
                ...
                if (centerImage) {
                  centerImage.onload = () => {
                    var _a;
                    (_a = this.context) == null ? void 0 : _a.drawImage(centerImage, canvasElement.width / 2 - centerImageWidth / 2, canvasElement.height / 2 - centerImageHeight / 2, centerImageWidth, centerImageHeight);
                  };
                }
              }
