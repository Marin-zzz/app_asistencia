  ...
  scanFromDeviceObservable(deviceId, previewEl) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        scan$.error(e);
        (_a = this.scannerControls) == null ? void 0 : _a.stop();
        this.scannerControls = void 0;
      }
...
var _ZXingScannerComponent = class _ZXingScannerComponent {
  ...
  set hints(hints) {
    var _a;
    this._hints = hints;
    (_a = this.codeReader) == null ? void 0 : _a.setHints(this._hints);
  }
  /**
  ...
  set videoConstraints(constraints) {
    var _a;
    const controls = (_a = this.codeReader) == null ? void 0 : _a.getScannerControls();
    if (!controls) {
      return;
    }
    controls == null ? void 0 : controls.streamVideoConstraintsApply(constraints);
  }
  /**
   *
   */
  ...
  isCurrentDevice(device) {
    var _a;
    return (device == null ? void 0 : device.deviceId) === ((_a = this._device) == null ? void 0 : _a.deviceId);
  }
  /**
  ...
  scanStop() {
    ...
    if (this._scanSubscription) {
      (_a = this.codeReader) == null ? void 0 : _a.getScannerControls().stop();
      (_b = this._scanSubscription) == null ? void 0 : _b.unsubscribe();
